   ...
   static void Main(string[] args)
   {
            ...
            /*
             * The for statement: xecutes its body while a specified Boolean expression evaluates to true.
            ...
            // enumerates the elemnts of a collection and executes its body for each element of the collection
            foreach (var item in simpleArray)
            {
                Console.WriteLine($"tCurrent item: {item}");
            }
            ...
            /* 
             * The do statement executes a statement or block of statements while a specified 
             * Boolean expression evaluates to true. Because that expression is evaluated after
             * each execution of the loop, a do loop executes one or more time. The do 
